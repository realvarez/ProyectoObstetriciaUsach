        ...
        @switch(\Route::currentRouteName())
            @case('category.show')
                ...
                <ol class="breadcrumb float-right" style="margin-right: 5em">
                    ...
                    <li style="margin-top: 0.35em">
                        <a data-toggle="modal" data-target="#newcategoryModal" style="color:black; cursor: pointer; margin-right: 15px; padding: 2px !important;"><i class="fas fa-folder-plus"></i> Nueva sub-categoría</a>
                    </li>
